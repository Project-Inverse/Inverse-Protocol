...
contract XIV is StandardToken, BurnableToken, ERC20Mintable {
    using SafeMath for uint256;

    string public constant symbol = "XIV";
    string public constant name = "XIV";

    uint8 public constant decimals = 18;
    uint256 public constant decimalFactor = 10**uint256(decimals);
    uint256 public constant INITIAL_SUPPLY = 0 * decimalFactor;
    ...
    function preSale(address _address, uint256 _amount)
        internal
        returns (bool)
    {
